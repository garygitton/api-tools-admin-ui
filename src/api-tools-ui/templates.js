...
angular.module("api-tools-ui/about/about.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/about/about.html",
    ...
    "      <strong>Laminas API Tools</strong> you can build APIs that enable mobile apps,\n" +
    ...
    "\n" +
    "    <p>\n" +
    "      The official web site of the project is <a href=\"https://api-tools.getlaminas.org\" target=\"_blank\">api-tools.getlaminas.org</a>.\n" +
    "    </p>\n" +
    "  </div>\n" +
    "</div>\n" +
    "");
...
angular.module("api-tools-ui/api-module/api-module.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/api-module/api-module.html",
    "<div class=\"panel panel-default\">\n" +
    "  <div class=\"panel-heading\">\n" +
    ...
    "          <td colspan=\"3\">\n" +
    "            <span ng-if=\"!vm.rest\"><img src=\"api-tools-ui/img/spinning.gif\"> Loading...</span>\n" +
    ...
    "          <td colspan=\"3\">\n" +
    "            <span ng-if=\"!vm.rpc\"><img src=\"api-tools-ui/img/spinning.gif\"> Loading...</span>\n" +
...
angular.module("api-tools-ui/authentication/authentication.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/authentication/authentication.html",
    "<div class=\"panel panel-default\">\n" +
    "  <div class=\"panel-heading\">\n" +
...
angular.module("api-tools-ui/content-negotiation/content-negotiation.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/content-negotiation/content-negotiation.html",
    "<div class=\"panel panel-default\">\n" +
    "  <div class=\"panel-heading\">\n" +
...
angular.module("api-tools-ui/dashboard/dashboard.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/dashboard/dashboard.html",
    ...
    "\n" +
    "      <p class=\"lead\">\n" +
    "        If this is the first time using <strong>Laminas API Tools</strong> we suggest\n" +
    "        you read the <a href=\"https://api-tools.getlaminas.org/documentation/intro/getting-started\"\n" +
...
angular.module("api-tools-ui/database/database.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/database/database.html",
    "<div class=\"panel panel-default\">\n" +
    "  <div class=\"panel-heading\">\n" +
...
angular.module("api-tools-ui/documentation/documentation-api.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/documentation/documentation-api.html",
    "<div class=\"panel panel-default\">\n" +
    "  <div class=\"panel-body\">\n" +
    ...
    "            <ng-include src=\"'api-tools-ui/documentation/documentation-service.html'\"></ng-include>\n" +
    "          </accordion-group>\n" +
...
angular.module("api-tools-ui/documentation/documentation-list.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/documentation/documentation-list.html",
...
angular.module("api-tools-ui/documentation/documentation-service.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/documentation/documentation-service.html",
    "<accordion-heading>\n" +
...
angular.module("api-tools-ui/documentation/documentation.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/documentation/documentation.html",
    "<div class=\"panel panel-default\">\n" +
    "  <div class=\"panel-heading\">\n" +
    "    <h3 class=\"panel-title\">Documentation <span ng-if=\"vm.apiName\"> of <strong>{{vm.apiName}}</strong> (v{{vm.version}})</span></h3>\n" +
    "  </div>\n" +
    "  <div class=\"panel-body\">\n" +
    "    <ng-include src=\"'api-tools-ui/documentation/documentation-list.html'\" ng-if=\"!vm.apiName\"></ng-include>\n" +
    "    <ng-include src=\"'api-tools-ui/documentation/documentation-api.html'\" ng-if=\"vm.apiName\"></ng-include>\n" +
    "  </div>\n" +
    "</div>\n" +
    "");
}]);

angular.module("api-tools-ui/header/header.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/header/header.html",
...
angular.module("api-tools-ui/modal/add-authoption.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/add-authoption.html",
...
angular.module("api-tools-ui/modal/add-dboption.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/add-dboption.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/add-filter.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/add-filter.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/add-service-description.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/add-service-description.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/add-validator.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/add-validator.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/delete-api.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/delete-api.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/delete-auth.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/delete-auth.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/delete-authoption.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/delete-authoption.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/delete-db.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/delete-db.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/delete-dboption.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/delete-dboption.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/delete-field.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/delete-field.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/delete-filter.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/delete-filter.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/delete-rest.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/delete-rest.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/delete-rpc.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/delete-rpc.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/delete-selector.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/delete-selector.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/delete-validator.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/delete-validator.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/delete-viewmodel.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/delete-viewmodel.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/edit-auth.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/edit-auth.html",
    "<div class=\"modal-header\">\n" +
    ...
    "        <span class=\"help-block\"><span class=\"glyphicon glyphicon-info-sign\" aria-hidden=\"true\"></span> If you don't know how to create a <i>htpasswd</i> file, read this <a href=\"https://api-tools.getlaminas.org/documentation/auth/authentication-http-basic\" target=\"_blank\">guide</a></span>\n" +
    "      </div>\n" +
    "    </div>\n" +
    "  </div>\n" +
    "  <!-- HTTP Digest -->\n" +
    ...
    "        <span class=\"help-block\"><span class=\"glyphicon glyphicon-info-sign\" aria-hidden=\"true\"></span> If you don't know how to create a <i>htdigest</i> file, read this <a href=\"https://api-tools.getlaminas.org/documentation/auth/authentication-http-digest\" target=\"_blank\">guide</a></span>\n" +
    "      </div>\n" +
    "    </div>\n" +
    "  </div>\n" +
    "  <!-- OAuth2 PDO -->\n" +
...
angular.module("api-tools-ui/modal/edit-authoption.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/edit-authoption.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/edit-db.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/edit-db.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/edit-dboption.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/edit-dboption.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/edit-field.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/edit-field.html",
    "<div class=\"modal-header\">\n" +
    ...
    "  <input type=\"checkbox\" ng-model=\"vm.field.type\" ng-true-value=\"Laminas\\InputFilter\\FileInput\" class=\"col-sm-2 control-label\">\n" +
...
angular.module("api-tools-ui/modal/edit-filter.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/edit-filter.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/edit-validator.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/edit-validator.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/edit-viewmodel.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/edit-viewmodel.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/new-api.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/new-api.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/new-auth.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/new-auth.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/new-db.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/new-db.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/new-doctrinestrategy.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/new-doctrinestrategy.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/new-field.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/new-field.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/new-selector.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/new-selector.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/new-service.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/new-service.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/new-version.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/new-version.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/new-viewmodel.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/new-viewmodel.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/modal/view-doctrineparams.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/modal/view-doctrineparams.html",
    "<div class=\"modal-header\">\n" +
...
angular.module("api-tools-ui/rest/rest.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/rest/rest.html",
    ...
    "              <span ng-if=\"!vm.sourcecode\"><img src=\"api-tools-ui/img/spinning.gif\"> Loading...</span>\n" +
...
angular.module("api-tools-ui/rpc/rpc.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/rpc/rpc.html",
...
angular.module("api-tools-ui/sidebar/sidebar.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("api-tools-ui/sidebar/sidebar.html",
    ...
    "    <span class=\"pull-left\" ng-show=\"vm.loading\"><img src=\"api-tools-ui/img/spinning.gif\"> Loading...</span>\n" +
    ...
    "            <span ng-if=\"!subItem.service_name\">{{subItem}} <img src=\"api-tools-ui/img/spinning.gif\"></span>\n" +
